...
export default function HomeScreen() {
  ...
  const handleRecipeIdeas = () => {
    if (Platform.OS === 'web') {
      window.location.assign('/recipe-ideas');
      return;
    }
  ...
  const handleScanFood = () => {
    if (Platform.OS === 'web') {
      window.location.assign('/scan-food');
      return;
    }
  ...
  const handleScanReceipt = () => {
    if (Platform.OS === 'web') {
      window.location.assign('/scan-receipt');
      return;
    }
  ...
  const handlePlanWeek = () => {
    if (Platform.OS === 'web') {
      window.location.assign(MEAL_PLAN_PREFERENCES_ROUTE);
      return;
    }

    router.push(MEAL_PLAN_PREFERENCES_ROUTE);
  };
  ...
  return (
    <ThemedView style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <ThemedView style={styles.actions}>
            <Pressable style={styles.planAction} onPress={handlePlanWeek}>
              <ThemedText type="default" style={styles.planActionText}>Plan my week</ThemedText>
            </Pressable>
            <Pressable style={styles.scanAction} onPress={handleScanFood}>
              <ThemedText type="default" style={styles.scanActionText}>Scan food</ThemedText>
            </Pressable>
            <Pressable style={styles.receiptAction} onPress={handleScanReceipt}>
            ...
            <Pressable style={styles.secondaryAction} onPress={handleRecipeIdeas}>
          ...
          <ThemedView style={styles.section}>
            {loading ? (
              <ThemedText type="small" themeColor="textSecondary">Loading your expiry dates...</ThemedText>
          ...
          <FeedbackBanner
            ...
            onDismiss={() => setResetComplete(false)}
          />
        )}
      ...
      <ModalDialog
        ...
        message="This removes all items and saved filter preferences. This action cannot be undone."
      ...
      <ModalDialog
        visible={!!resetError}
        title="Reset failed"
        message={resetError || 'Failed to reset inventory'}
        primaryButtonText="OK"
        onPrimaryPress={() => setResetError(null)}
